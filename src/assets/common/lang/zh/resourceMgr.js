...
export default {
  ...
  loginVcenter: "登入vCenter", // 登入Vcenter
  clusterNameplaceholder: "请输入集群名称", // 请输入集群名称
  clusterStatus: "集群状态", // 集群状态
  BMC_IPaddress: "BMC IP地址",
  clusterStatusObj: {
    ONLINE: "在线", // "在线",
    OFFLINE: "离线", // "离线",
    EXCEPTION: "异常", // "异常",
  },
  bmcIpCantNull: "BMC IP不得为空",
  clusterRemark: "描述", // 描述
  bmcAccountCantNull: "BMC账号不得为空",
  ...
  clusterSettingInfo: "配置信息", // 存储信息
  clusterConfirmInfo: "确认信息", // 确认信息

  clusterAdminName: "用户名", // 用户名
  clusterAdmin: "集群管理员", // 集群管理员
  clusterAdminPasswordplac: "请输入集群管理员密码", // 请输入集群管理员密码
  clusterAdminPassword: "密码", // 密码
  clusterEditPassword: "修改密码", // 修改密码
  rootPassword: "root密码", // root密码
  rootPasswordplac: "请输入root密码", // 请输入root密码
  ...
  allocationStorageEditMsg:
    "分配存储数不能大于上级可用数，并且不能小于已使用数", // 分配存储数不能大于上级可用数，并且不能小于已使用数
  ...
  deleteSuccess: "删除成功",
  shutdownTips: "确认将裸金属服务器“{name}”关机？",
  shutdownManyTips: "确认批量将裸金属服务器“{name}”关机？",
  ...
  abortconfirmMsg:
    "此操作可能导致云服务器内尚未保存的数据丢失，是否确认强制关机？", // 此操作可能导致云服务器内尚未保存的数据丢失，是否确认强制关机？
  abortconfirmTit: "强制关机", // 强制关机
  abortSucc: "强制关机成功!", // 强制关机成功!
  abortErr: "强制关机失败!", // 强制关机失败!

  forcedRestartconfirmMsg:
    "此操作可能导致云服务器内尚未保存的数据丢失，是否确认强制重启？", // 此操作可能导致云服务器内尚未保存的数据丢失，是否确认强制关机？
  ...
  zoneCREATE_KCP_IMAGE: "正在制作模板镜像", //  正在制作模板镜像
  zoneSNAPSHOT_RUNNING: "正在快照", //  正在快照
  zoneOther: "其他", //  其他
  type: "类型", //  类型
  userName: "所有者", //  所有者
  ...
  BMCAccount: "BMC账号",
  nameCantNull: "名称不得为空",
  surePowerOffTips: "确认认将“{name}”关机？",
  addBareMetal: "添加裸金属服务器",
  editBareMetal: "编辑裸金属服务器",
  summary: {
    summary: "概要", //  概要
    type: "告警类型", //  告警类型
    date: "告警时间", //  告警时间
  ...
  network: {
    network: "网络", //  网络
    numberOfQueues: "队列个数", // Number of queues
    ...
    networkHierarchy: "网络层级",
    networkType: "网络类型",
    none: "无",
    netSpecEditSuccess: "网络规格编辑成功", //The network specifications were edited successfully
    netSpecCreatSuccess: "网络规格创建成功", //The network specifications are created successfully
    advacedSetting: "高级设置", //Advanced Settings
    auto: "自动", //automatic
    netSpecSec: "二级网络", //Secondary network
    netSpec3rd: "三级网络", //Three-level network
    netSpecName: "网络规格名称",
    selectnetworkType: "请选择网络类型",
    addNetTop1: " 没有合适的网络规格? 前往",
    addNetTop2: "进入物理集群详情 -> 网络 -> 创建网络规格",
  },
  task: {
    action: "操作", //  操作
    objName: "对象名称", //  对象名称
  ...
  storage: {
    ...
    sure: "确定",
    cancel: "取消",
    disTips: "禁用后，自服务用户的云服务器不可使用此存储池",
    enableTips: "启用后，自服务用户的云服务器可使用此存储池",
    success: "成功",
    disk: "存储", //  存储
    diskName: "名称", //  名称
    device: "存储类型", //  存储类型
  ...
  layerNet2: "二层网络",
  layerNet3: "三层网络",
  delSpecTips: "此操作将删除该网络规格, 是否继续?",
  delManySpecTips: "此操作将批量删除选中网络规格, 是否继续?",
  tips: "提示",
  pubNet: "公有网络",
  vpcNet: "VPC网络",
  netSeg: "网络段",
  editNetSpec: "编辑网络规格",
  createNetSpec: "创建网络规格",
  ipAcq: "IP获取",
  selectNetLevel: "请选择网络层级",
  selectCardType: "请选择网卡类型",
  selectSecPolicy: "请选择安全策略",
  selectVirFirewall: "请选择虚拟防火墙",
  selectThreeLayerNet: "请选择三层网络",
  selectEffectGroup: "请选择需要生效的安全组",
  macPool: "mac地址池",
  netSepcDetail: "网络规格详情",
  autoDhcp: "自动（DHCP）",
};
