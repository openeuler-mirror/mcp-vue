...
import { pagePhysicalHostEvent } from "@/api/monitoringApi";
  ...
  data() {
    return {
      ...
      columnArr: [
        ...
        {
          label: this.$t("monitoring.serverEvtMap.server"), // "服务器",
          prop: "hostname",
          sortable: "custom",
          width: "250px",
        },
        {
          label: this.$t("monitoring.serverEvtMap.mutableTags"), // "资源",
          prop: "mutableTags",
          width: "250px",
          sortable: false,
          tooltipsFlag: true,
