...
import headerBar from "./clusterAlarmlogHeader.vue";
import { pageAlarmLog } from "@/api/monitoringApi";

export default {
  name: "clusterAlarmlog",
  components: {
    headerBar,
    mcTable,
  },
  ...
  methods: {
    ...
    renderTable() {
      ...
      let params = {
        ...
        type: this.type, // 类型
        objectType: this.objectType, // 对象类型
